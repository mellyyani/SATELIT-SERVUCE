                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    if(isset($_POST['filter_tgl'])){
                                        ...
                                        $ambilsemuadatastok = mysqli_query($conn,"select * from masuk m, stok s where s.idbarang = m.idbarang and tanggal BETWEEN '$mulai' and DATE_ADD('$selesai',INTERVAL 1 DAY)order by idmasuk DESC");
                                    } else {
                                        $ambilsemuadatastok = mysqli_query($conn,"select * from masuk m, stok s where s.idbarang = m.idbarang order by idmasuk DESC");
                                    }
